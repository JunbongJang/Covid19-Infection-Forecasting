...
from src.EDA.parseJohnsHopkins import getTzuHsiCluster
...
def visualize_cases_trend(ax, mean_cases_series, vel_cases_df, days, chosen_cluster, Rnot_index,
    ...
    plt.xlabel('Days since 3/20/20', fontsize='large')
...
if __name__ == "__main__":
    ...
    for chosen_cluster_id in range(8,11):
        ...
        mean_population_series = population_df.mean(axis=1)
        ...
        cluster_mean_population = mean_population_series.to_numpy()[0]
        N_SAMPLES = 10000
